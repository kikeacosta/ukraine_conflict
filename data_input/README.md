...
|---|---|---|
| `ucdp_ged_events_slim.rds` (1.7 MB) | `ucdp/GEDEvent_*.csv` | 259 MB |
...
- `260919_UKR_ualosses_Personnel_v19.xlsx` — v19, 19 September 2026: every
  age–sex count, and the last release in the linkage
...
| `migration/` | UNHCR Data Finder extract, UNHCR's 2022 border crossings by month (the timing of 2022's net outflow), CES figures, Canada/USA placeholder anchors, and reference copies — see `migration/README.md` |
